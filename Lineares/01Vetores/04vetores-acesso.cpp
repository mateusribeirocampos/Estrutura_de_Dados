...
int main (){
    ...
    std::cout << "vetor[0] = " << primeiroElemento << std::endl; // Saída: "vetor[0] = 1

    // Acessando o 5º elemento do vetor
    int elementoIntermediario = vetor[4]; // Saída: 5

    std::cout << "vetor[4] = " << elementoIntermediario << std::endl; // Saída: "vetor[4] = 5"  

    // Acessando o último elemento do vetor
    int ultimoElemento = vetor[vetor.size() - 1]; // Saída: 10

    std::cout << "vetor[vetor.size() - 1] = " << ultimoElemento << std::endl; // Saída: "vetor[vetor.size() - 1] = 10"
