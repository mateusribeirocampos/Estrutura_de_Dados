...
int main()
{
    ...
    std::cout << "Antes: " << " p1 = " << p1 << ", p2 = " << p2 << ", p3 =" << p3 << std::endl;
    std::cout << "Antes: " << " *p1 = " << *p1 << ", *p2 = " << *p2 << ", *, p3 = " << *p3 << std::endl;
    std::cout << "Antes: " << " &p1 = " << &p1 << ", &p2 =  " << &p2 << ", &p3 =  " << &p3 << std::endl;
    std::cout << "Antes: " << " a = " << a << ", b = " << b << ", c = " << c << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "Depois: " << " p1 = " << p1 << ", p2 = " << p2 << ", p3 = " << p3 << std::endl;
    std::cout << "Depois: " << " *p1 = " << *p1 << ", *p2 = " << *p2 << ", *p3 = " << *p3 << std::endl;
    std::cout << "Depois: " << " &p1 = " << &p1 << ", &p2 = " << &p2 << ", &p3 =  " << &p3 << std::endl;
    std::cout << "Depois: " << " a = " << a << ", b = " << b << ", c = " << c << std::endl;
    std::cout << std::endl;
